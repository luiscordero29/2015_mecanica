            ...
            <div class="col-sm-12">
                <div class="box">
                            ...
                            <div class="panel-body">
                            	...
                            	<fieldset>
                                <legend>Crear Veh&iacute;culo</legend>                                    
                                <div class="row">
                                    <div class="col-sm-3">
                                        <label for="placa">Placa del Veh&iacute;culo:</label>
                                        <input type="text" name="placa" id="placa" class="form-control" maxlength="250" required autofocus>
                                    </div> 
                                    <div class="col-sm-3">
                                        <label for="periodo">Año:</label>
                                        <input type="text" name="periodo" id="periodo" class="form-control" maxlength="4" required>
                                    </div> 
                                    <div class="col-sm-3">
