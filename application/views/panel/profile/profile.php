                            ...
                            ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" name="identidad" id="identidad" class="form-control" maxlength="15" autofocus value="<?php echo $row['identidad']; ?>">
                                    </div> 
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="apellidos" id="apellidos" class="form-control" maxlength="120" required value="<?php echo $row['apellidos']; ?>" autofocus >
                                    </div>                                    
                                    <div class="col-sm-6">
