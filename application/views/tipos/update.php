            ...
            <div class="col-sm-12">
                <div class="box">
                            ...
                            <div class="panel-body">
                                ...
                                <fieldset>
                                <legend>Editar Tipo de Veh&iacute;culo</legend>                                    
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label for="tipo">Tipo de Veh&iacute;culo:</label>
                                        <input type="text" name="tipo" id="tipo" class="form-control" maxlength="250" required autofocus value="<?php echo $row['tipo']; ?>">
                                    </div>                               
                                </div>     
