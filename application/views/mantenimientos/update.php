            ...
            <div class="col-sm-12">
                <div class="box">
                            ...
                            <div class="panel-body">
                                ...
                                <fieldset>
                                <legend>Editar Tipo de Mantenimiento</legend>                                    
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label for="mantenimiento">Tipo de Mantenimiento:</label>
                                        <input type="text" name="mantenimiento" id="mantenimiento" class="form-control" maxlength="250" required autofocus value="<?php echo $row['mantenimiento']; ?>">
                                    </div>                               
                                </div>     
