                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <select name="id_marca" id="id_marca" class="form-control" required autofocus>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" name="modelo" id="modelo" class="form-control" maxlength="250" required autofocus>
                                    </div>                               
                                </div>
