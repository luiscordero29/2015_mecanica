                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <div class="input-group date" id="datepicker" data-date="<?php echo date("d/m/Y", strtotime($row['fecha'])); ?>" data-date-format="dd/mm/yyyy"> 
                                        <input type="text" name="fecha" class="form-control" type="text" readonly="" value="<?php echo date("d/m/Y", strtotime($row['fecha'])); ?>" required> 
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" name="costo" id="costo" class="form-control" maxlength="250" required autofocus value="<?php echo $row['costo']; ?>">
                                    </div> 
                                    <div class="col-sm-3">
                                        ...
                                        <select name="id_mantenimiento" id="id_mantenimiento" class="form-control" required>
                                            ...
                                            <option value="<?php echo $r['id_mantenimiento']; ?>" <?php  if($row['id_mantenimiento']==$r['id_mantenimiento']){ echo 'selected'; } ?>><?php echo $r['mantenimiento']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-sm-3">
                                        ...
                                        <select name="id_area" id="id_area" class="form-control" required>
                                            ...
                                            <option value="<?php echo $r['id_area']; ?>" <?php  if($row['id_area']==$r['id_area']){ echo 'selected'; } ?>><?php echo $r['area']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-sm-12">
                                        <label for="descripcion">Descripci&oacute;n:</label>
                                        <textarea name="descripcion" class="form-control" rows="10" required><?php echo $row['descripcion']; ?></textarea>
                                    </div>
                                    <div class="col-sm-12">
                                        <label for="observacion">Observaci&oacute;n:</label>
                                        <textarea name="observacion" class="form-control" rows="10"><?php echo $row['observacion']; ?></textarea>
                                    </div>                              
                                </div>
