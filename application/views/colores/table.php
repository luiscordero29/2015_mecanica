  <div class="container">
    <div class="row">                            
      ...
      <div class="panel-heading"><h4>GESTOR DE COLORES</h4></div>
                      ...
                      <tr>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu" role="menu">
                              ...
                              <li><a href="<?php echo site_url($controller.'/update/'.$r['id_color']); ?>"><span class="glyphicon glyphicon-pencil"></span> Editar</a></li>
                              <li><a href="<?php echo site_url($controller.'/delete/'.$r['id_color']); ?>"><span class="glyphicon glyphicon-remove"></span> Eliminar</a></li>                                 
                          </ul>
                        </div>
